...
import { Heart, Users, Shield, Chat } from '@phosphor-icons/react';
    ...
    <div className="min-h-screen bg-[#0B0A0F]">
      ...
      <section className="relative pt-32 pb-24 px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-[#A8A3B2] max-w-3xl mx-auto mb-8">
            A free, private community for couples and singles in North Alabama and Southern Tennessee.
            Connect, message freely, exchange numbers - just be nice and respectful!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              data-testid="hero-get-started-btn"
              onClick={() => navigate('/register')}
              className="px-12 py-4 rounded-full bg-[#B22234] text-[#F7F5F0] text-lg font-semibold hover:bg-[#D62839] transition-all duration-300 transform hover:-translate-y-1"
            >
              Join Free Now
            </button>
            <button
              onClick={() => navigate('/guidelines')}
              className="px-12 py-4 rounded-full border-2 border-[#D4AF37] text-[#D4AF37] text-lg font-semibold hover:bg-[#D4AF37] hover:text-[#0B0A0F] transition-all duration-300"
            >
      ...
      <section className="py-24 px-8 bg-[#14121A]">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-[#A8A3B2] mb-16 max-w-2xl mx-auto">
            No hidden fees, no premium tiers. Just connect with real people in your area.
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <FeatureCard
              ...
              description="Browse members in your area"
            />
            <FeatureCard
      ...
      <section className="py-24 px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="glass-effect p-8 rounded-2xl mb-8">
            <p className="text-2xl text-[#F7F5F0] mb-4 heading-font">
