  ...
  return (
    <div className="min-h-screen bg-[#0B0A0F]">
      ...
      <main className="max-w-7xl mx-auto px-8 py-12">
        <h1 className="heading-font text-4xl font-bold text-[#F7F5F0] mb-6">Chatrooms</h1>
        <div className="glass-effect p-12 rounded-2xl text-center">
          <p className="text-[#A8A3B2]">Live chatrooms - Connect with multiple members in real-time</p>
        </div>
      </main>
    </div>
  );
