    ...
    <div className="min-h-screen bg-[#0B0A0F]">
      ...
      <main className="max-w-7xl mx-auto px-8 py-12">
        <div className="mb-8">
          ...
          <p className="text-[#A8A3B2]">Submit your photos and vote for the week's winner</p>
        </div>
        <div className="glass-effect p-12 rounded-2xl text-center">
          <p className="text-[#A8A3B2]">Contest entries and voting - Winners get spotlighted for a week</p>
        </div>
      </main>
    </div>
  );
